...
<nav class="navbar navbar-expand-md navbar-dark bg-primary">
    <div class="container">
        <a href="{{ route('home') }}" class="navbar-brand mb-0 h1"></i> List Data</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap">
                ...
                <li class="nav-item col-2 col-md-auto"><a href="{{ route('barang.create') }}" class="nav-link @if($currentRouteName == 'list') active @endif">Update Barang</a></li>
            </ul>
